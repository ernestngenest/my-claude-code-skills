...
**Perbedaan dengan `/grill-me`:** `/grill-with-docs` statefu — menyimpan hasil ke `CONTEXT.md` dan ADRs. Gunakan ini kalau ada kodebase. Gunakan `/grill-me` kalau tidak ada kodebase.
